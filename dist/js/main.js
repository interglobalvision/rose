...
var _smoothscrollPolyfill = __webpack_require__(10);
...
var Site = function () {
  ...
  _createClass(Site, [{
    ...
    key: 'handleScrollTo',
    value: function handleScrollTo($section) {
      window.scroll({
    ...
    key: 'handleSectionOpen',
    value: function handleSectionOpen(target, $section) {
